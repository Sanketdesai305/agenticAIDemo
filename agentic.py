  ...
  build:
    ...
    steps:
      ...
      - name: Set up Java
        ...
        with:
          java-version: '11'
          distribution: '{java_distribution}'  # Dynamic Java distribution
      ...
      # Install dependencies and run tests based on the project type
...
build_success = False
attempt = 0
MAX_ATTEMPTS = 3  # Try maximum 3 times to auto-fix and build
